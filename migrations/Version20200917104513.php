 ...
 */
final class Version20200917104513 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article ADD author_id INT DEFAULT NULL, ADD introduction_image LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article DROP author_id, DROP introduction_image');
    }
}
